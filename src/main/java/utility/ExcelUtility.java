...
public class ExcelUtility 
	{
		...
		public void setExcelFile(String sheetPath, String sheetName) throws IOException
			{
				try
					{
						FileInputStream input = new FileInputStream(sheetPath);
		...
		public String getCellData(int rowNumb, int colNumb) throws IOException
			{
				try
					{
		...
		private int getTestCaseRow(String testCaseName, int testCaseColumn) throws IOException
			{
				int row=0;
				try
					{
		...
		public Map getData(String testCaseName, String sheetPath, String sheetName) throws IOException
			{
